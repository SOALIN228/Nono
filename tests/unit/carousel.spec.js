...
describe('Carousel.vue', () => {
  ...
  it('接受 CarouselItem，默认展示第一个.', (done) => {
    Vue.component('NCarouselItem', CarouselItem)
    const wrapper = mount(Carousel, {
      ...
      slots: {
        default: `
          <n-carousel-item name="1">
            <div class="box1">1</div>
          </n-carousel-item>
          <n-carousel-item name="2">
            <div class="box2">2</div>
          </n-carousel-item>
          <n-carousel-item name="3">
  ...
  it('会自动播放', (done) => {
    ...
    setTimeout(() => {
      expect(callback).to.have.been.calledWith('2') // 被调参数为2
      done()
    }, 21)
  })
  it('可以点击上一张', (done) => {
